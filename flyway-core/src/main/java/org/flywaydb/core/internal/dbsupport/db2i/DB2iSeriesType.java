...
/**
 * DB21 for iSeries specific type.
 */
public class DB2iSeriesType extends Type {
    /**
     ...
     */
    public DB2iSeriesType(JdbcTemplate jdbcTemplate, DbSupport dbSupport, Schema schema, String name) {
