...
/**
 * DB2 for iSeries  -specific function.
 */
public class DB2iSeriesFunction extends Function {
     ...
     */
    public DB2iSeriesFunction(JdbcTemplate jdbcTemplate, DbSupport dbSupport, Schema schema, String name, String... args) {
